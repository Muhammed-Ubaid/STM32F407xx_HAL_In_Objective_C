...
typedef struct
{
	struct GPIO_RegDef_t* Private_GPIO_Data;
 ...
 * Data read and write
 */
uint8_t GPIO_ReadFromInputPin(GPIO_Config_UserHandle_t UserHandle);
uint16_t GPIO_ReadFromInputPort(GPIO_Config_UserHandle_t UserHandle);
void GPIO_WriteToOutputPin(GPIO_Config_UserHandle_t UserHandle);
void GPIO_WriteToOutputPort(GPIO_Config_UserHandle_t UserHandle);
